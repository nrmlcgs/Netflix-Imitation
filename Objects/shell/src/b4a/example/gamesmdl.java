...
public class gamesmdl implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("gamesmdl"), "b4a.example.gamesmdl");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, gamesmdl.class);
...
public static b4a.example.searchmdl _searchmdl = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",gamesmdl.mostCurrent._activity,"CategoriesMdl",Debug.moduleToString(b4a.example.categoriesmdl.class),"DownloadMdl",Debug.moduleToString(b4a.example.downloadmdl.class),"FastMdl",Debug.moduleToString(b4a.example.fastmdl.class),"HomeMdl",Debug.moduleToString(b4a.example.homemdl.class),"LblEnd",gamesmdl.mostCurrent._lblend,"Main",Debug.moduleToString(b4a.example.main.class),"NewMdl",Debug.moduleToString(b4a.example.newmdl.class),"ProfilesMdl",Debug.moduleToString(b4a.example.profilesmdl.class),"ReadyMdl",Debug.moduleToString(b4a.example.readymdl.class),"ScrollView1",gamesmdl.mostCurrent._scrollview1,"SearchMdl",Debug.moduleToString(b4a.example.searchmdl.class),"SignInMdl",Debug.moduleToString(b4a.example.signinmdl.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"StartMdl",Debug.moduleToString(b4a.example.startmdl.class),"UserMdl",Debug.moduleToString(b4a.example.usermdl.class)};
}
}