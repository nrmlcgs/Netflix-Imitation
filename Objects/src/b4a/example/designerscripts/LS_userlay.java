...
//BA.debugLineNum = 4;BA.debugLine="Label2.HorizontalCenter = 50%x"[UserLay/General script]
views.get("label2").vw.setLeft((int)((50d / 100 * width) - (views.get("label2").vw.getWidth() / 2)));
//BA.debugLineNum = 5;BA.debugLine="Panel1.HorizontalCenter = 50%x"[UserLay/General script]
